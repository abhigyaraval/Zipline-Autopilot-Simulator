...
# #########################
#
#     pilot = subprocess.Popen(['python3', 'autopilot.py'], stdin=subprocess.PIPE, stdout=subprocess.PIPE)
...
#
    ...
    while result is None:
        ...
        #     break
        # lateral_airspeed, drop_package_c, _ = COMMAND_STRUCT.unpack(cmd)
        # print("Main: " + str(loop_count))
        # print("Inner: " + str(drop_package_c))
        # ######### DELETE
        ...
        if api_mode:
            ...
            print("Main: " + str(loop_count))
            print("Inner: " + str(drop_package_commanded_byte))
